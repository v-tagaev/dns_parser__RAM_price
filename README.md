...
Проект распространяется под лицензией MIT. Подробности — в файле [LICENSE](LICENSE). ИСпользуйте как хотите, не нарушая закон. Мне все равно
